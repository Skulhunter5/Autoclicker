...
int main()
{
	...
	::RegisterClassEx(&wc);
	HWND hwnd = ::CreateWindow(wc.lpszClassName, _T("Autoclicker"), WS_OVERLAPPEDWINDOW, (1920 - Window::width) / 2, (1080 - Window::height) / 2, Window::width, Window::height, NULL, NULL, wc.hInstance, NULL);
...
LRESULT WINAPI WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	if (IntWndProc(msg, wParam, lParam))
		return true;
